...
const buildingElementSchema = new mongoose.Schema({
  ...
  ifc_class: String,
  materials_info: [{
    materialId: mongoose.Schema.Types.ObjectId, // Original material ID from the IFC, if applicable
    name: String,
    volume: Number,
    matched_material_id: mongoose.Schema.Types.ObjectId, // ID of the matched material from your database
