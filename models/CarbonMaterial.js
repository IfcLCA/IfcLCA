...
const carbonMaterialSchema = new mongoose.Schema({
  ...
  "BAUMATERIALIEN": {
    type: String,
    required: true // Assuming this is the primary field you're interested in
  },
  "ID-Nummer Entsorgung": String,
  "Entsorgung": String,
  "Rohdichte/Flächenmasse": String, // Kept as String if it includes non-numeric values like "-"
  "Bezug": String,
  // Include other fields as needed, converting numeric strings to numbers where appropriate
...
const CarbonMaterial = mongoose.model('Carbon_data', carbonMaterialSchema, 'carbon_data_KBOB');
